## pacmod_game_control (kinetic) - 3.0.2-1

The packages in the `pacmod_game_control` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic --track kinetic pacmod_game_control --edit` on `Mon, 13 Apr 2020 17:16:50 -0000`
...
## pacmod_game_control (lunar) - 2.3.0-0

The packages in the `pacmod_game_control` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro lunar --track lunar pacmod_game_control` on `Wed, 12 Dec 2018 22:16:09 -0000`
...
## pacmod_game_control (kinetic) - 2.3.0-0

The packages in the `pacmod_game_control` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic --track kinetic pacmod_game_control` on `Wed, 12 Dec 2018 21:11:26 -0000`
...
## pacmod_game_control (indigo) - 2.3.0-0

The packages in the `pacmod_game_control` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --ros-distro indigo --track indigo pacmod_game_control` on `Wed, 12 Dec 2018 20:51:41 -0000`
...
## pacmod_game_control (kinetic) - 2.2.0-0

The packages in the `pacmod_game_control` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic --track kinetic pacmod_game_control --edit` on `Fri, 31 Aug 2018 20:10:55 -0000`
...
## pacmod_game_control (indigo) - 2.2.0-1

The packages in the `pacmod_game_control` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --ros-distro indigo --track indigo pacmod_game_control --edit` on `Fri, 31 Aug 2018 20:08:00 -0000`
...
## pacmod_game_control (indigo) - 2.2.0-0
